...
// 跟車卡「結束」鈕(iOS 17 LiveActivityIntent):在鎖定畫面/動態島上直接收卡,【不】打開 App。
...
//    比照 RailFollowAttributes 的雙 target 鐵則,不可各複製一份。
@available(iOS 17.6, *)
struct RailFollowEndIntent: LiveActivityIntent {
    static let title: LocalizedStringResource = "結束跟車追蹤"
