...
# 多良、平交道 09-23 11:14 改成使用者自己在車庫頁轉的「鐵道迷角度」，由 Android session 重拍。
# 視角、重拍指令都寫在桌面 實作交接.md；使用者要 iOS「照這組重做」，所以裁切跟 Android 用同一組：
#   duoliang t=5.5  整列車剛出隧道、車頭在月台遊客旁邊（11:48 使用者看 A54 後「可以，多良就用這版」；
#                 要「看得到欄杆、海、列車與一些遊客」）
#                 外框 白天 (1652, 754, 1895, 911)、夜間 (1533, 759, 1895, 968) → 中卡 pt 白天 (182, −4, 262, 48)
#                 cx／cw 跟 Android (1652, 886, 1100) 相同，cy 往下 24px（畫面往上挪 8pt）：車頭留在 38pt
#                 淡出起點附近、遊客不掉進淡出區；車頭在 x 182–210pt，右上「更新」膠囊（x 280–348、y 39–57pt）
#                 蓋不到。最後一節車頂被上緣切掉一點，跟 Android 一樣（接受）
#   crossing t=11.38  兩台 DR1000 都在平交道上  合起來 (1473, 953, 1948, 1141) → 小卡 pt (98, 10, 179, 42)；
#                 小卡太窄，框的是平交道＋兩台車頭，車尾在站名牌後面、車頭超出右緣（跟 Android 一樣）
SCENES = [
    ('widget-scene-viaduct-l', 'viaduct', (364, 150), (1838, 1315, 1330)),
    ('widget-scene-duoliang-m', 'duoliang', (364, 96), (1652, 910, 1100)),
    ('widget-scene-crossing-s', 'crossing', (170, 96), (1395, 1174, 1000)),
]
