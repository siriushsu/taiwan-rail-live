...
#   duoliang t=2  藍皮車頭剛出隧道        外框 (1801, 716, 1966, 829) → 中卡 pt (277, 0, 335, 40)
#                 cy 比 Android 的 818 往下 34px（畫面往上挪 12pt）：iOS 中卡右上角有「更新」膠囊
#                 （y 約 39–57pt），不挪的話會蓋住車頭下半
...
SCENES = [
    ...
    ('widget-scene-duoliang-m', 'duoliang', (364, 96), (1528, 852, 1043)),
