...
#   crossing t=14.7 前排那台停在平交道正中央（使用者 09-23「平交道請截圖車子在平交道中央的圖」）
#                  前排 (1428, 999, 1732, 1119) → 小卡 pt (111, 19, 144, 32)；後排那台剛開出平交道，
#                  在它右邊 (1680, 1009, 1984, 1129) → pt (139, 20, 172, 33)，車尾貼右緣。
#                  平交道比較靠場景左緣，要把兩台都框進來，左上角會露出一點場景外的底色
SCENES = [
    ('widget-scene-viaduct-l', 'viaduct', (364, 150), (1838, 1315, 1330)),
    ('widget-scene-duoliang-m', 'duoliang', (364, 96), (1519, 1259, 1680)),
    ('widget-scene-crossing-s', 'crossing', (170, 96), (1191, 1264, 1550)),
]
