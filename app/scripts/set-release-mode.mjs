...
const MODES = {
  ...
  feature: {
    marketing: '1.4.10', build: '78', music: true, metroCore: true, // 78＝77 的全部內容(＝76＋地圖修法),只換行銷版號:1.4.9 train 已關閉
    why: '軌島 1.4.10：台鐵車站看板可以挑一班車追蹤，鎖定畫面顯示它的表定時刻與官方誤點分鐘（實際約幾點到）。並修好地圖的縮放與拖曳：兩指縮放放手時軌道不再先跳回原處再彈回來，拖曳地圖時軌道與列車不再比底圖慢半拍。',
  },
