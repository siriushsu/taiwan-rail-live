...
const MODES = {
  ...
  feature: {
    marketing: '1.5.1', build: '81', music: true, metroCore: true, // 80=1.5.0 送審顆(基底 f30b4da=橫式 v5,與本機測試顆 907 同載貨)。ASC 線上 1.4.10 (79) 已發佈(08-23),train 已關,1.5.0 為新版本項目。出這顆時 HEAD 落後 origin/main 恰 1 顆=418fbe3(ship-web 網站部署鏈,不進 App bundle,刻意不併)。900 系照舊只裝自己 iPhone,不上傳 ASC
