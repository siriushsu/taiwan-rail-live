...
const MODES = {
  ...
  feature: {
    marketing: '1.4.2', build: '43', music: true,
    why: '軌島 1.4.2：App 有新版會主動提示並可直接評分、車站看板顯示可轉乘的鐵道系統、「附近車站」與「隨機跟隨」互斥不搶鏡頭、捷運畫面速度上界修正；沿用 1.4.1 的背景音樂續播、鎖屏自動換站、高鐵自由座車廂、我的車・準點、準點排行；production 資格，TestFlight Sandbox 通道維持關閉。',
  },
