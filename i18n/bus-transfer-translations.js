(function (global) {
  ...
  messages.en = Object.assign(messages.en || {}, {
    ...
    '進站中': 'Arriving', '約 1 分': 'About 1 min', '（未命名路線）': '(Unnamed route)',
    ...
    '接續旅程': 'Continuing journey', '已選': 'Selected', '公車': 'Bus', '{route}・{from} → {to}': '{route} · {from} → {to}',
    ...
    '下車站': 'alighting stop', '原預估已過，請重新查詢': 'The earlier estimate has passed. Refresh for the latest bus.',
  ...
  messages.ja = Object.assign(messages.ja || {}, {
    ...
    '接續旅程': '乗換後の旅程', '已選': '選択済み', '公車': 'バス', '{route}・{from} → {to}': '{route}・{from} → {to}',
    ...
    '下車站': '降車停留所', '原預估已過，請重新查詢': '前の予測時刻を過ぎました。最新情報を再照会してください。',
