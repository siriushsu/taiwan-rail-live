(() => {
  ...
  Object.assign(messages.en, {
    ...
    '{date}｜誤點 {n} 分': '{date} | {n} min late', '近 {n} 天逐日誤點長條圖': 'Daily delays over the past {n} days',
    ...
    '載入誤點履歷…': 'Loading delay history…', '登入並訂閱通行證後，可看台鐵列車近 {n} 天逐日與週幾誤點履歷。': 'Sign in and subscribe to view {n} days of daily and weekday delay history for TRA trains.',
    ...
    '近 {n} 天逐日最終誤點': 'Final daily delay over {n} days', '各週幾平均誤點': 'Average delay by weekday',
    '資料：交通部 TDX 運輸資料流通服務平臺・軌島每日彙整': 'Data: Ministry of Transportation TDX · compiled daily by Rail Island', '統計區間 {range}': 'Period: {range}',
    '解鎖 {n} 天逐日與週幾誤點統計': 'Unlock {n}-day daily and weekday delay statistics',
  ...
  Object.assign(messages.ja, {
    ...
    '近 30 天平均誤點 {average} 分・準點 {rate}%（{days} 天）': '過去30日平均遅延{average}分・定時{rate}%（{days}日）', '誤點履歷 ›': '遅延履歴 ›', '單日最大誤點 {n} 分': '1日の最大遅延{n}分', '{date}｜誤點 {n} 分': '{date}｜{n}分遅れ', '近 {n} 天逐日誤點長條圖': '過去{n}日の日別遅延グラフ',
    ...
    '登入並訂閱通行證後，可看台鐵列車近 {n} 天逐日與週幾誤點履歷。': 'ログインしてパスを購読すると、台湾鉄路列車の過去{n}日の日別・曜日別遅延履歴を確認できます。', '訂閱通行證解鎖完整履歷': 'パスを購読して全履歴を表示', '暫時無法載入誤點履歷{status}，稍後再試。': '遅延履歴を一時取得できません{status}。後でもう一度お試しください。',
    '誤點履歷資料累積中，天數足夠後會顯示完整圖表。': '遅延履歴を蓄積中です。日数が揃うとグラフを表示します。', '近 {n} 天逐日最終誤點': '過去{n}日の日別最終遅延', '各週幾平均誤點': '曜日別平均遅延', '資料：交通部 TDX 運輸資料流通服務平臺・軌島每日彙整': 'データ：交通部TDX・軌島が毎日集計', '統計區間 {range}': '集計期間 {range}', '解鎖 {n} 天逐日與週幾誤點統計': '{n}日の日別・曜日別遅延統計を解除',
