(() => {
  ...
  Object.assign(messages.ja, {
    ...
    "近景列車依推估股道分流，少量交疊會暫時靠旁避讓；捷運到站時保留立體車身，不再瞬間變回號碼。阿里山林鐵暫不套股道，停站的車不再畫到軌道外": "近景の列車を推定した線路に振り分け、残る重なりは一時的な表示上の退避で対応します。地下鉄の停車中も3D車体を保ちます。阿里山森林鉄道は当面この推定を使わず、駅に停車中の列車が線路の外に描かれることがなくなりました。",
    "推估股道": "推定線路",
    "暫時避讓（示意）": "一時退避（イメージ）",
