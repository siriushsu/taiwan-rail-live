(() => {
  ...
  Object.assign(messages.en, {
    '英文與日文現在也會即時更新最愛、今日台鐵、誤點履歷、帳號同步、Google 清單匯入、分享與 App 等車卡；官方活動只有中文時，會清楚標示「中文原文」': 'English and Japanese now update favourites, Today’s TRA, delay history, account sync, Google list imports, sharing and App wait cards immediately. Chinese-only official events are clearly labelled as source text.',
  ...
  Object.assign(messages.ja, {
    '英文與日文現在也會即時更新最愛、今日台鐵、誤點履歷、帳號同步、Google 清單匯入、分享與 App 等車卡；官方活動只有中文時，會清楚標示「中文原文」': '英語・日本語で、お気に入り、本日の台湾鉄路、遅延履歴、アカウント同期、Googleリスト読み込み、共有、Appの列車待ちカードもすぐ切り替わるようになりました。中国語だけの公式イベントは原文であることを明記します。',
