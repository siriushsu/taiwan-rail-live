(() => {
  ...
  Object.assign(messages.en, {
    ...
    "近景列車依推估股道分流，少量交疊會暫時靠旁避讓；捷運到站時保留立體車身，不再瞬間變回號碼。阿里山林鐵暫不套股道，停站的車不再畫到軌道外；阿里山、祝山的軌道補畫到站裡，神木一帶補上之字形折返的股道": "Close-up trains use inferred tracks, with temporary visual yielding for remaining overlaps. Metro trains keep their 3D bodies when stopping at stations. The Alishan Forest Railway skips inferred tracks for now, so trains waiting at its stations no longer appear off the rails. Its drawn track now reaches into Alishan and Zhushan, and the switchback spurs around Shenmu are drawn in.",
    "推估股道": "Inferred track",
  ...
  Object.assign(messages.ja, {
    ...
    "近景列車依推估股道分流，少量交疊會暫時靠旁避讓；捷運到站時保留立體車身，不再瞬間變回號碼。阿里山林鐵暫不套股道，停站的車不再畫到軌道外；阿里山、祝山的軌道補畫到站裡，神木一帶補上之字形折返的股道": "近景の列車を推定した線路に振り分け、残る重なりは一時的な表示上の退避で対応します。地下鉄の停車中も3D車体を保ちます。阿里山森林鉄道は当面この推定を使わず、駅に停車中の列車が線路の外に描かれることがなくなりました。線路の描画も阿里山・祝山の駅構内まで延び、神木周辺のスイッチバック側線も描かれます。",
    "推估股道": "推定線路",
    "暫時避讓（示意）": "一時退避（イメージ）",
