(() => {
  ...
  // App 出貨線（字級三階／資料狀態卡／群組切換／站內回報／等車卡／捷運小工具／面板半透明）
  // 併入 main 的多語線時補齊的英日文。2026-08-29。
  Object.assign(messages.en, {
    "{n} 班車": { one: "{n} train", other: "{n} trains" },
    "{n} 個地點": { one: "{n} place", other: "{n} places" },
    "{n} 趟": { one: "{n} ride", other: "{n} rides" },
    "移除收藏": "Remove from favorites",
    "總里程": "Total distance",
    "收集章": "Stamps",
    "最遠征": "Farthest journey",
    "非即時": "Not live",
    "台鐵誤點目前非即時：依 {time} 的即時資料投射 · {n} 班誤點中": { one: "TRA delays are not live: projected from the {time} feed · {n} train delayed", other: "TRA delays are not live: projected from the {time} feed · {n} trains delayed" },
    "找不到就檢查一下車次是不是今天的班次——停駛或加班車不一定在時刻表裡。": "If nothing matches, check whether the train runs today — canceled and extra services may not be in the timetable.",
    "顯示車種與方向": "Show train type and direction",
    "桌面版的四顆分頁就在頂端資訊列上，直接點就能換": "On desktop the four tabs sit in the top information bar — just tap one to switch",
    "字": "Aa",
    "候": "M",
    "回": "!",
    "班": "T",
    "桌": "W",
    "字級": "Text size",
    "三階字級與跟隨系統字級。": "Three text sizes, plus an option to follow the system text size.",
    "「更多」→ 字級，開啟「顯示與字級」": "More → Text size, then open “Display and text size”",
    "選標準／大／特大，面板下方會即時預覽": "Pick Standard, Large or Extra Large — a live preview sits below the panel",
    "「跟隨系統字級」可以關掉——手機字調大、但這一頁想維持資訊密度時用": "“Follow system text size” can be turned off — useful when your phone is set large but you want to keep more information on this screen",
    "「大」只放大字級與列高，功能位置完全不變；跟隨系統只在字級進到輔助使用級別才介入。": "“Large” only increases text and row height; the controls stay in the same places. Following the system only kicks in at accessibility sizes.",
    "切換：全台／台鐵／高鐵／捷運": "Switch: All / TRA / HSR / Metro",
    "決定地圖上要出現哪些系統的車。手機收在頂端那顆圓鈕裡，點一下展開四個選項。": "Chooses which systems appear on the map. On phones it lives in the round button at the top — tap to open the four options.",
    "手機：點頂端右邊那顆圓鈕（上面寫著目前在哪一群）": "Phone: tap the round button at the top right (it shows which group you are in)",
    "從選單挑全台同框／台鐵／高鐵／捷運與輕軌": "Pick All Taiwan / TRA / HSR / Metro and light rail from the menu",
    "桌面：頂端資訊列上的四顆分頁直接點": "Desktop: tap one of the four tabs in the top information bar",
    "切換不會重新框景——你原本看的地方還在原地。字級調大時那顆鈕會跟著變大，但位置不變。": "Switching doesn’t change the map view — you stay where you were. The button grows with larger text, but does not move.",
    "點時鐘＝現在的資料是不是即時的": "Tap the clock to see whether the data is live.",
    "時鐘旁邊就是資料狀態——畫面夠寬時直接寫出來（LIVE、非即時、尖峰…），窄的時候依序收成小色點，「即時」那顆最後才收。點一下時鐘，會逐項寫出每一項代表什麼、以及為什麼是這個狀態。": "Data status sits next to the clock — spelled out when there is room (LIVE, Not live, Peak…), and collapsed into colored dots when there is not, with “live” the last to collapse. Tap the clock to see what each one means and why it is in that state.",
    "點頂端的時鐘（桌面點時鐘那張卡）": "Tap the clock at the top (on desktop, the clock card)",
    "逐列看：台鐵即時誤點是 LIVE 還是「非即時」、捷運看板校正到哪、是不是在重播、目前時段與車數": "Row by row: whether TRA live delays are LIVE or “Not live”, the status of metro board corrections, whether you are replaying, and the current period and train count",
    "每一列下面會說明原因——資料幾分鐘沒更新、裝置時鐘差幾秒、時間軸不在現在": "Each row explains why — how many minutes since the data updated, how far your device clock is off, whether the timeline is away from now",
    "「非即時」不是另一種資料，是同一份官方資料現在不夠新，畫面依稍早那份投射。手機沒有滑鼠停留可看，所以把原因都攤在這張卡裡。": "“Not live” is not a different data source — it is the same official data, just no longer fresh, with the view projected from the earlier snapshot. Phones have no hover, so every reason is laid out on this card.",
    "台鐵套用官方即時誤點；北捷依官方秒級到站倒數逐班校正，高捷、機捷、高雄輕軌依官方到站看板校正。官方資料中斷或你的裝置時鐘明顯不準時，上方的「LIVE」會轉成灰色「非即時」，表示畫面是依稍早的資料投射——點一下時鐘可以看到是哪一項出狀況。台鐵當日官方公告停駛的班次不會出現在地圖上，但看板仍會列出並標成「停駛」。": "TRA uses official live delays. Taipei Metro is corrected train by train from the official second-by-second countdowns; Kaohsiung Metro, Taoyuan Airport MRT and Kaohsiung light rail are corrected from the official arrival boards. If the official feed breaks or your device clock is clearly off, “LIVE” at the top turns into a grey “Not live”, meaning the view is projected from earlier data — tap the clock to see which item is affected. TRA services officially canceled for the day do not appear on the map, but the boards still list them marked “Cancelled”.",
    "捷運小工具（主畫面／鎖定畫面）": "Metro widgets (Home Screen / Lock Screen)",
    "把捷運站放上主畫面或鎖定畫面，不開 App 就看得到下一班往哪裡、還有幾分鐘。": "Put a metro station on your Home or Lock Screen and see where the next train is heading and how many minutes away it is, without opening the app.",
    "長按主畫面空白處進入編輯，從加入小工具的入口搜尋「軌島」": "Press and hold an empty spot on the Home Screen to edit, then search for “Rail Island” where widgets are added",
    "選捷運小工具，再挑一個車站；鎖定畫面也放得下": "Choose the metro widget, then pick a station — it fits on the Lock Screen too",
    "倒數依官方即時到站資訊更新。這項不需要通行證。": "The countdown updates from the official live arrival data. No pass required.",
    "想放多站，或用「自動（最近的站）」讓它跟著你移動換站，需要軌島通行證（免費可設定一站）": "Adding multiple stations—or using “Automatic (nearest station)” so the widget follows you as you move—requires a Rail Island Pass (one station is free)",
    "還有一張「鐵路＋捷運看板」大卡，把台鐵、高鐵與捷運的發車資訊列在同一張。點小工具會直接開啟軌島到那一站。": "There is also a large “Rail + metro board” card that lists TRA, HSR and metro departures together. Tapping the widget opens Rail Island at that station.",
    "在這站等車：鎖定畫面倒數": "Waiting at this station: Lock Screen countdown",
    "在月台上等車時，把這一站的下一班倒數放上鎖定畫面與動態島，不用一直把 App 開著。": "While you wait on the platform, show this station’s next-train countdown on the Lock Screen and Dynamic Island instead of keeping the app open.",
    "點北捷、高捷或機捷的車站打開看板": "Tap a Taipei Metro, Kaohsiung Metro or Taoyuan Airport MRT station to open its board",
    "按站名下方的「追蹤這站」，選方向與要追蹤多久（30／60／90 分鐘）": "Tap “Track this station” under the station name, then choose the direction and how long to track (30 / 60 / 90 minutes)",
    "車進站自動換成下一班，時間到自動收起": "It rolls to the next train as each one arrives, and closes itself when the time is up",
    "在台鐵車站等一班車：鎖定畫面倒數": "Waiting for a TRA train: Lock Screen countdown",
    "在月台等某一班車時，把那一班的倒數放上鎖定畫面與動態島，不用一直把 App 開著。": "While you wait on the platform for a particular train, show that train’s countdown on the Lock Screen and Dynamic Island instead of keeping the app open.",
    "點台鐵車站打開看板": "Tap a TRA station to open its board",
    "從「接下來的班次」挑你要等的那一班": "Pick the train you are waiting for from “Upcoming departures”",
    "按站名旁的「追蹤一班車」": "Tap “Track a train” next to the station name",
    "倒數照官方表定加即時誤點，車到站後自動收起。鎖定畫面同時只留一張等候卡——追蹤台鐵這班會把捷運那張收掉。時鐘不在「現在」時會先幫你帶回現在。這項不需要通行證。": "The countdown follows the official timetable plus live delays, and closes itself once the train arrives. Only one waiting card stays on the Lock Screen at a time — tracking this TRA train closes the metro one. If the timeline is not set to Now, the app returns it to Now first. No pass required.",
    "App 留在前景時藍點與所在地鏡頭會持續跟著你；「附近車站」告訴你最近的車站與下一班車還有幾分鐘。": "While the app stays in the foreground, the blue dot and the map keep following your location; “Nearby stations” tells you the closest station and how many minutes until the next train.",
    "首次會問定位權限；Android 建議開啟「精確位置」": "You are asked for location permission the first time; on Android, “Precise location” is recommended",
    "手動拖圖會解除所在地鏡頭，定位藍點仍持續更新": "Dragging the map stops it following your location; the blue dot keeps updating",
    "按「附近車站」回到目前位置，點清單裡的站直接開看板": "Tap “Nearby stations” to return to where you are, then tap a station in the list to open its board",
    "點地圖空白處小卡會收成一顆膠囊——跟車不會斷，點膠囊就展開回來": "Tapping an empty part of the map collapses the card into a compact capsule — following does not stop, and tapping the capsule expands it again",
    "真的要結束按卡片上的「結束」": "To actually stop, press “End” on the card",
    "按小卡上的「結束」停止跟車(× 只是把卡收起來,車還在跟)": "Press “End” on the card to stop following (× only tucks the card away — the train is still being followed)",
    "跟到終點會蓋一枚完乘章（收在「護照」）。加速播放沒問題，但中途跳時間就不算。手機在跟車途中點車站，看板會和跟車小卡併成同一張卡的兩個分頁，不會互相蓋掉。": "Following a train all the way to the terminus earns a completion stamp (kept in “Passport”). Fast playback is fine, but skipping through time does not count. On a phone, tapping a station while following merges the board and the following card into two tabs of one card, so neither covers the other.",
    "看到不對的地方，可以帶著當下的畫面資訊回報。": "If something looks wrong, you can report it together with what is on screen right now.",
    "按頁尾（手機在「更多」的關於段）的「回報問題或建議」": "Tap “Report a problem or suggestion” in the footer (on phones, in the About section under More)",
    "選一個類型、寫一句說明": "Choose a category and write one line about it",
    "確認要一起附上的資訊——每一項都可以單獨關掉": "Check what will be attached — each item can be switched off individually",
    "按「前往 GitHub 開 issue」，內容會幫你填好": "Tap “Open an issue on GitHub” — the content is filled in for you",
    "附上的只有版本、目前畫面、地圖視角、跟隨中的列車與瀏覽器版本，不含帳號與定位。開 issue 需要 GitHub 帳號，issue 內容是公開的。": "Only the version, current view, map viewport, the train being followed and the browser version are attached — no account or location data is included. Opening an issue needs a GitHub account, and issues are public.",
    "讓看板、列車卡與跟隨面板透出後方地圖，面板底下的路線、車站都看得到；面板最上方的標題列也一起透。": "Lets the boards, train cards and follow panel show the map behind them, so the lines and stations underneath stay visible — the title bar at the top of the panel is translucent too.",
    "預設關閉；這項設定只會記在目前這台裝置。半透明時字色會自動調整以維持可讀性（亮色加深、暗色提亮），不是靠在字外加光暈。": "Off by default, and remembered only on this device. When translucent, text color is adjusted automatically to stay readable — darker on light, lighter on dark — rather than adding a glow around the text.",
    "通行證內容：台鐵列車的誤點履歷（回溯 90 天的逐日紀錄）、iPhone 桌面與鎖定畫面的捷運小工具放多站或用「自動（最近的站）」跟著你移動換站（免費可設定一站）、收藏與完乘紀錄跨裝置雲端同步、行程分享、在 App 匯入 Google Maps 已儲存清單、App 非跟車時的衛星高解析圖磚，以及 iOS 17.6 以上可用的跟車鎖定畫面與動態島即時動態。": "What the pass includes: delay history for TRA trains (day-by-day records going back 90 days); metro widgets on the iPhone Home and Lock Screen with multiple stations or “Automatic (nearest station)” that follows you as you move (one station is free); cloud sync of favorites and ride records across devices; trip sharing; importing your saved Google Maps lists in the app; high-resolution satellite tiles when not following a train; and Lock Screen and Dynamic Island Live Activities while following a train, on iOS 17.6 or later.",
  });
  Object.assign(messages.ja, {
    "{n} 班車": "{n}本の列車",
    "{n} 個地點": "{n}か所",
    ...
    "最遠征": "最長遠征",
    "非即時": "非リアルタイム",
    "台鐵誤點目前非即時：依 {time} 的即時資料投射 · {n} 班誤點中": "台湾鉄路の遅延は現在リアルタイムではありません：{time}のデータから推定・{n}本が遅延中",
    "找不到就檢查一下車次是不是今天的班次——停駛或加班車不一定在時刻表裡。": "見つからないときは、その列車が今日運行するか確認してください。運休や臨時列車は時刻表にない場合があります。",
    "顯示車種與方向": "列車種別と方面を表示",
    "桌面版的四顆分頁就在頂端資訊列上，直接點就能換": "デスクトップ版では上部の情報バーに4つのタブがあり、タップで切り替えられます",
    "字": "字",
    "候": "待",
    "回": "報",
    "班": "本",
    "桌": "ウ",
    "字級": "文字サイズ",
    "三階字級與跟隨系統字級。": "3段階の文字サイズとシステム連動。",
    "「更多」→ 字級，開啟「顯示與字級」": "「その他」→文字サイズで「表示と文字サイズ」を開く",
    "選標準／大／特大，面板下方會即時預覽": "標準／大／特大を選ぶと、パネル下部でその場でプレビューできます",
    "「跟隨系統字級」可以關掉——手機字調大、但這一頁想維持資訊密度時用": "「システムの文字サイズに合わせる」はオフにできます。端末の文字を大きくしていても、この画面は情報量を保ちたいときに使います",
    "「大」只放大字級與列高，功能位置完全不變；跟隨系統只在字級進到輔助使用級別才介入。": "「大」は文字と行の高さを大きくするだけで、配置は変わりません。システム連動はアクセシビリティ用サイズになったときだけ働きます。",
    "切換：全台／台鐵／高鐵／捷運": "切り替え：台湾全体／台湾鉄路／高鉄／メトロ",
    "決定地圖上要出現哪些系統的車。手機收在頂端那顆圓鈕裡，點一下展開四個選項。": "地図に表示する事業者を選びます。スマートフォンでは上部の丸いボタンにまとまっており、タップすると4つの選択肢が開きます。",
    "手機：點頂端右邊那顆圓鈕（上面寫著目前在哪一群）": "スマートフォン：右上の丸いボタンをタップ（現在のグループが表示されています）",
    "從選單挑全台同框／台鐵／高鐵／捷運與輕軌": "メニューから台湾全体／台湾鉄路／高鉄／メトロ・ライトレールを選ぶ",
    "桌面：頂端資訊列上的四顆分頁直接點": "デスクトップ：上部の情報バーにある4つのタブをタップ",
    "切換不會重新框景——你原本看的地方還在原地。字級調大時那顆鈕會跟著變大，但位置不變。": "切り替えても地図の表示範囲は変わりません。見ていた場所のままです。文字を大きくするとボタンも大きくなりますが、位置は変わりません。",
    "點時鐘＝現在的資料是不是即時的": "時計をタップ＝いまのデータがリアルタイムかどうか",
    "時鐘旁邊就是資料狀態——畫面夠寬時直接寫出來（LIVE、非即時、尖峰…），窄的時候依序收成小色點，「即時」那顆最後才收。點一下時鐘，會逐項寫出每一項代表什麼、以及為什麼是這個狀態。": "データの状態は時計の隣にあります。幅に余裕があれば文字で（LIVE、非リアルタイム、ピークなど）、狭いときは順に小さな色の点にまとまり、「リアルタイム」が最後まで残ります。時計をタップすると、各項目の意味と現在の状態の理由が1行ずつ表示されます。",
    "點頂端的時鐘（桌面點時鐘那張卡）": "上部の時計をタップ（デスクトップでは時計のカード）",
    "逐列看：台鐵即時誤點是 LIVE 還是「非即時」、捷運看板校正到哪、是不是在重播、目前時段與車數": "行ごとに確認：台湾鉄路の遅延がLIVEか「非リアルタイム」か、メトロ案内の補正状況、再生中かどうか、現在の時間帯と列車数",
    "每一列下面會說明原因——資料幾分鐘沒更新、裝置時鐘差幾秒、時間軸不在現在": "各行の下に理由が表示されます：データが何分更新されていないか、端末の時計が何秒ずれているか、タイムラインが現在からずれているか",
    "「非即時」不是另一種資料，是同一份官方資料現在不夠新，畫面依稍早那份投射。手機沒有滑鼠停留可看，所以把原因都攤在這張卡裡。": "「リアルタイムではありません」は別のデータではなく、同じ公式データが新しくなくなった状態で、少し前のデータから推定して表示しています。スマートフォンではマウスオーバーが使えないため、理由をすべてこのカードに並べています。",
    "台鐵套用官方即時誤點；北捷依官方秒級到站倒數逐班校正，高捷、機捷、高雄輕軌依官方到站看板校正。官方資料中斷或你的裝置時鐘明顯不準時，上方的「LIVE」會轉成灰色「非即時」，表示畫面是依稍早的資料投射——點一下時鐘可以看到是哪一項出狀況。台鐵當日官方公告停駛的班次不會出現在地圖上，但看板仍會列出並標成「停駛」。": "台湾鉄路は公式のリアルタイム遅延を反映します。台北メトロは公式の秒単位カウントダウンで1本ずつ補正し、高雄メトロ、桃園空港MRT、高雄ライトレールは公式の到着案内で補正します。公式データが途切れたり端末の時計が大きくずれている場合、上部の「LIVE」が灰色の「非リアルタイム」に変わり、少し前のデータからの推定表示であることを示します。時計をタップするとどれが原因か分かります。当日公式に運休となった台湾鉄路の列車は地図には出ませんが、案内には「運休」と表示されます。",
    "捷運小工具（主畫面／鎖定畫面）": "メトロウィジェット（ホーム画面／ロック画面）",
    "把捷運站放上主畫面或鎖定畫面，不開 App 就看得到下一班往哪裡、還有幾分鐘。": "メトロの駅をホーム画面やロック画面に置くと、アプリを開かずに次の列車の方面と待ち時間が分かります。",
    "長按主畫面空白處進入編輯，從加入小工具的入口搜尋「軌島」": "ホーム画面の空いている場所を長押しして編集に入り、ウィジェット追加から「軌島」を検索",
    "選捷運小工具，再挑一個車站；鎖定畫面也放得下": "メトロウィジェットを選び、駅を指定します。ロック画面にも置けます",
    "倒數依官方即時到站資訊更新。這項不需要通行證。": "カウントダウンは公式のリアルタイム到着情報で更新されます。パスは不要です。",
    "想放多站，或用「自動（最近的站）」讓它跟著你移動換站，需要軌島通行證（免費可設定一站）": "複数の駅や、移動に合わせて駅が変わる「自動（最寄り駅）」には軌島パスが必要です（1駅までは無料）",
    "還有一張「鐵路＋捷運看板」大卡，把台鐵、高鐵與捷運的發車資訊列在同一張。點小工具會直接開啟軌島到那一站。": "台湾鉄路・高鉄・メトロの発車情報を1枚にまとめた大型の「鉄道＋メトロ案内」ウィジェットもあります。ウィジェットをタップすると、その駅で軌島が開きます。",
    "在這站等車：鎖定畫面倒數": "この駅で待つ：ロック画面のカウントダウン",
    "在月台上等車時，把這一站的下一班倒數放上鎖定畫面與動態島，不用一直把 App 開著。": "ホームで待っている間、この駅の次の列車のカウントダウンをロック画面とダイナミックアイランドに表示できます。アプリを開いたままにする必要はありません。",
    "點北捷、高捷或機捷的車站打開看板": "台北メトロ、高雄メトロ、桃園空港MRTの駅をタップして案内を開く",
    "按站名下方的「追蹤這站」，選方向與要追蹤多久（30／60／90 分鐘）": "駅名の下の「この駅を追跡」をタップし、方面と追跡時間（30／60／90分）を選ぶ",
    "車進站自動換成下一班，時間到自動收起": "列車が到着すると次の1本に切り替わり、時間になると自動的に閉じます",
    "在台鐵車站等一班車：鎖定畫面倒數": "台湾鉄路の列車を待つ：ロック画面のカウントダウン",
    "在月台等某一班車時，把那一班的倒數放上鎖定畫面與動態島，不用一直把 App 開著。": "ホームで特定の列車を待つ間、その列車のカウントダウンをロック画面とダイナミックアイランドに表示できます。アプリを開いたままにする必要はありません。",
    "點台鐵車站打開看板": "台湾鉄路の駅をタップして案内を開く",
    "從「接下來的班次」挑你要等的那一班": "「これからの列車」から待っている1本を選ぶ",
    "按站名旁的「追蹤一班車」": "駅名の横の「列車を追跡」をタップ",
    "倒數照官方表定加即時誤點，車到站後自動收起。鎖定畫面同時只留一張等候卡——追蹤台鐵這班會把捷運那張收掉。時鐘不在「現在」時會先幫你帶回現在。這項不需要通行證。": "カウントダウンは公式時刻表にリアルタイム遅延を反映したもので、列車が到着すると自動的に閉じます。ロック画面に残る待機カードは同時に1枚だけで、この台湾鉄路の列車を追跡するとメトロのカードは閉じます。時計が「現在」からずれている場合は、先に現在へ戻します。パスは不要です。",
    "App 留在前景時藍點與所在地鏡頭會持續跟著你；「附近車站」告訴你最近的車站與下一班車還有幾分鐘。": "アプリが前面にある間は、青い点と現在地カメラが移動に追従します。「近くの駅」では最寄り駅と次の列車までの分数が分かります。",
    "首次會問定位權限；Android 建議開啟「精確位置」": "初回に位置情報の許可を確認します。Androidでは「正確な位置情報」を推奨します",
    "手動拖圖會解除所在地鏡頭，定位藍點仍持續更新": "地図をドラッグすると現在地追従は解除されますが、青い点は更新され続けます",
    "按「附近車站」回到目前位置，點清單裡的站直接開看板": "「近くの駅」で現在地に戻り、一覧の駅をタップすると案内が開きます",
    "點地圖空白處小卡會收成一顆膠囊——跟車不會斷，點膠囊就展開回來": "地図の空いている場所をタップするとカードは小さなカプセル表示に畳まれます。追跡は止まらず、カプセルをタップすると元に戻ります",
    "真的要結束按卡片上的「結束」": "本当に終了するときはカードの「終了」を押します",
    "按小卡上的「結束」停止跟車(× 只是把卡收起來,車還在跟)": "カードの「終了」で追跡を停止します（×はカードを畳むだけで、追跡は続いています）",
    "跟到終點會蓋一枚完乘章（收在「護照」）。加速播放沒問題，但中途跳時間就不算。手機在跟車途中點車站，看板會和跟車小卡併成同一張卡的兩個分頁，不會互相蓋掉。": "列車を終点まで追跡すると完乗スタンプがもらえます（「パスポート」に保存）。早送り再生は問題ありませんが、途中で時間を飛ばすと対象外です。スマートフォンで追跡中に駅をタップすると、案内と追跡カードが1枚のカードの2つのタブにまとまり、互いに隠れません。",
    "看到不對的地方，可以帶著當下的畫面資訊回報。": "おかしいところがあれば、いまの画面の情報を添えて報告できます。",
    "按頁尾（手機在「更多」的關於段）的「回報問題或建議」": "フッターの「問題や提案を報告」をタップ（スマートフォンでは「その他」の「軌島について」内）",
    "選一個類型、寫一句說明": "種類を選び、説明を1行書く",
    "確認要一起附上的資訊——每一項都可以單獨關掉": "一緒に添付する情報を確認します。項目ごとに個別にオフにできます",
    "按「前往 GitHub 開 issue」，內容會幫你填好": "「GitHubでissueを作成」をタップすると、内容が入力済みで開きます",
    "附上的只有版本、目前畫面、地圖視角、跟隨中的列車與瀏覽器版本，不含帳號與定位。開 issue 需要 GitHub 帳號，issue 內容是公開的。": "添付されるのはバージョン、現在の画面、地図の表示範囲、追跡中の列車、ブラウザのバージョンだけで、アカウントや位置情報は含みません。issueの作成にはGitHubアカウントが必要で、内容は公開されます。",
    "讓看板、列車卡與跟隨面板透出後方地圖，面板底下的路線、車站都看得到；面板最上方的標題列也一起透。": "案内、列車カード、追跡パネルの背後に地図が透けて見えるようになり、パネルの下の路線や駅も見えます。パネル上部のタイトルバーも同様に透過します。",
    "預設關閉；這項設定只會記在目前這台裝置。半透明時字色會自動調整以維持可讀性（亮色加深、暗色提亮），不是靠在字外加光暈。": "初期状態はオフで、この設定はこの端末にのみ保存されます。半透明のときは文字色を自動調整して読みやすさを保ちます（明るい背景では濃く、暗い背景では明るく）。文字の外側に光彩を加える方式ではありません。",
    "通行證內容：台鐵列車的誤點履歷（回溯 90 天的逐日紀錄）、iPhone 桌面與鎖定畫面的捷運小工具放多站或用「自動（最近的站）」跟著你移動換站（免費可設定一站）、收藏與完乘紀錄跨裝置雲端同步、行程分享、在 App 匯入 Google Maps 已儲存清單、App 非跟車時的衛星高解析圖磚，以及 iOS 17.6 以上可用的跟車鎖定畫面與動態島即時動態。": "パスに含まれるもの：台湾鉄路の列車の遅延履歴（過去90日間の日別記録）、iPhoneのホーム画面とロック画面のメトロウィジェットで複数駅を設定、または移動に合わせて駅が変わる「自動（最寄り駅）」（1駅までは無料）、お気に入りと完乗記録の複数端末クラウド同期、旅程の共有、アプリ内でのGoogleマップ保存済みリストの読み込み、列車を追跡していないときの高解像度衛星タイル、そしてiOS 17.6以降で使える追跡中のロック画面・ダイナミックアイランドのライブアクティビティ。",
  });
