...
export function createLandscapeTrees({map,THREE,scene,world,clearance,getTerrain}){
  ...
  async function rebuild(){
    ...
    const stale=()=>disposed||getTerrain()!==terrain||clearance.revision!==railRevision||map.getZoom()<14.5||Math.hypot((map.getCenter().lng-c.lng)*MX,(map.getCenter().lat-c.lat)*MY)>300;
