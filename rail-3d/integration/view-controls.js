...
export function mountViewControls({translate:t}) {
  ...
  function layout(){
    const mobile=document.body.classList.contains('mobile-shell'),stage=document.querySelector('.stage').getBoundingClientRect();dock.classList.toggle('view-mobile',mobile);
