...
# 泰安：山線舊站/新站兩個節點同名，取目前實際營運的新站（較南側）。
DISAMBIGUATE_NODE_ID = {
    "泰安": 774940566,  # 24.3225724, 120.7492097（新泰安）
}
...
LINE_DEFS = [
    {
        ...
        "stations": [
            "基隆", "三坑", "八堵", "七堵", "五堵", "汐止", "汐科", "南港", "松山",
            "臺北", "萬華", "板橋", "浮洲", "樹林", "山佳", "鶯歌", "桃園", "鳳鳴",
    ...
    },
    {
        ...
        "offpeakHeadwaySec": 1200,
        "stations": [
            "竹南", "造橋", "豐富", "苗栗", "南勢", "銅鑼", "三義", "勝興", "泰安",
            "后里", "豐原", "栗林", "潭子", "頭家厝", "松竹", "太原", "臺中", "五權",
            "大慶", "新烏日", "烏日", "彰化",
        ],
    },
    {
