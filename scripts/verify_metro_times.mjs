...
const OFFICIAL_TRAINS = [
  ...
  ...['平日', '假日'].map(set => ({ file: 'data/tymc_times.json', line: 'A', set, kind: '1',
    ...
    stops: [[0, '台北車站', '23:08'], [1, '三重站', '23:16'], [2, '新北產業園區站', '23:20'], [3, '新莊副都心站', '23:22'],
      ...
      [9, '山鼻站', '23:50'], [10, '坑口站', '23:53'], [11, '機場第一航廈站', '23:57'], [12, '機場第二航廈站', '23:59'], [13, '機場旅館站', '24:02'],
      [14, '大園站', '24:05'], [15, '橫山站', '24:08'], [16, '領航站', '24:11'], [17, '高鐵桃園站', '24:15'], [18, '桃園體育園區站', '24:18'],
      [19, '興南站', '24:23'], [20, '環北站', '24:27']] })),
  ...
  // resource 968f7322-36ca-43c4-816c-9f8448a9b4fb)三站字面值,另由北捷看板帳本(D1 trtc_events)
  // 09-15～09-17 三個平日三站都有真車到站佐證。產物目前只有這三站的片段(整班還沒接出來),只驗這三站。
  // 76ad9ca7 的同分修法把它併進一條會被全停站閘門丟掉的鏈,整段消失,出貨前沒抓到(09-18 補回)。
  { file: 'data/trtc_times.json', line: 'R', set: '平日',
    src: '淡水信義線 圓山 06:12 往廣慈/奉天宮',
    stops: [[13, '圓山', '06:12'], [12, '民權西路', '06:14'], [11, '雙連', '06:16']] },
];
