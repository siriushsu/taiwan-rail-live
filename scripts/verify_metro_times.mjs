...
const OFFICIAL_TRAINS = [
  ...
  { file: 'data/tymc_times.json', line: 'A', set: '平日', kind: '1', endsAt: 20, validThrough: '2026-10-11',
    ...
    stops: [[0, '台北車站', '18:04'], [1, '三重站', '18:10'], [2, '新北產業園區站', '18:14'], [3, '新莊副都心站', '18:16'],
      ...
      [19, '興南站', '19:15']] },
  // 10/2(週五)的○區間車不在 TDX(TDX 平日＝官網週一至四版),由 data/special_ops.json 的
  // tymc-20261002-expo-friday 補成當日例外班表。官網 A12／A21 各站時刻表(查詢日期 2026-10-02,
  // 2026-09-25 實查)。date:驗「那天前端實際會選到的那一組」——dates 對錯也在考題裡。
  { file: 'data/tymc_times.json', line: 'A', set: '設計展週五', date: '2026-10-02', kind: '1', endsAt: 20, validThrough: '2026-10-02',
    src: '機捷南下 ○機場第一航廈 10:49 區間車(10/2 設計展疏運)',
    stops: [[11, '機場第一航廈站', '10:49'], [12, '機場第二航廈站', '10:51'], [13, '機場旅館站', '10:54'], [14, '大園站', '10:57'],
      [15, '橫山站', '11:00'], [16, '領航站', '11:03'], [17, '高鐵桃園站', '11:07'], [18, '桃園體育園區站', '11:10'], [19, '興南站', '11:15']] },
  { file: 'data/tymc_times.json', line: 'A', set: '設計展週五', date: '2026-10-02', kind: '1', endsAt: 11, validThrough: '2026-10-02',
    src: '機捷北上 ○環北 21:59 區間車(10/2 設計展疏運)',
    stops: [[20, '環北站', '21:59'], [19, '興南站', '22:03'], [18, '桃園體育園區站', '22:08'], [17, '高鐵桃園站', '22:12'],
      [16, '領航站', '22:16'], [15, '橫山站', '22:19'], [14, '大園站', '22:22'], [13, '機場旅館站', '22:25'], [12, '機場第二航廈站', '22:28']] },
...
for (const rel of FILES) {
  ...
  for (const o of OFFICIAL_TRAINS.filter(o => o.file === rel)) {
    ...
    if (o.date) {
      const routed = lines[o.line] && lines[o.line].dates && lines[o.line].dates[o.date];
      ck(routed === o.set, `${o.line} ${o.date} 前端走「${o.set}」班表（產物 dates 指向 ${routed || '無'}）`);
    }
